...
<div class="row">
    <div class="col-md-6">
        ...
        <!-- Basic layout-->
        <form action="{{ route('delegate.store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"> {{ trans('dash.add_new_delegate') }} </h5>                    
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="number" name="identity_number" class="form-control" value="{{ old('identity_number') }}" placeholder="{{ trans('dash.identity_number') }}" >
                        </div>
                    </div>
                    <div class="form-group">
