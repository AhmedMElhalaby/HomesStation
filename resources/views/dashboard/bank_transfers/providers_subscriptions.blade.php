...
<div class="panel panel-flat tb_padd">
    <div class="panel-heading">
        <h5 class="panel-title"> {{ trans('dash.bank_transfers.bank_transfers') }} : {{ trans('dash.bank_transfers.providers_subscriptions') }} </h5>        
    </div>
    <table class="table table-condensed table-hover datatable-highlight">
        <thead>
            <tr>
                ...
                <th class="text-center"> {{ trans('dash.subscription.subscription') }} </th>
        ...
        <tbody>
            ...
            <tr id="row_{{ $bank_transfer->id }}">
                ...
                <td class="text-center"> {{ $bank_transfer->Subscription->name_ar }} </td>                                
