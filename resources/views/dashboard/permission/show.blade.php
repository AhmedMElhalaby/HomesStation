...
@section('script')
    <script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/core/libraries/jasny_bootstrap.min.js"></script>
	...
	<script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/plugins/forms/styling/uniform.min.js"></script>
	<script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/plugins/ui/fullcalendar/fullcalendar.min.js"></script>
	{{--  <script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/plugins/visualization/echarts/echarts.js"></script>  --}}

	<script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/core/app.js"></script>
	{{--  <script type="text/javascript" src="{{ url('../resources/assets/dashboard/material') }}/assets/js/pages/user_profile_tabbed.js"></script>  --}}
    ...
    <div class="col-lg-3">
        ...
        <div class="sidebar-content">
            ...
            <div class="content-group">
                <div class="panel-body bg-indigo-400 border-radius-top text-center" style="background-image: url({{ url('../resources/assets/dashboard/material') }}/assets/images/bg.jpg); background-size: contain;">
