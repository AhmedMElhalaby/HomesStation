...
<div class="row">
    <div class="col-md-6">
        <!-- Basic layout-->
        <form action="{{ route('admin.update', $admin->id) }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="username" value="{{ $admin->username }}" placeholder="{{ trans('dash.username') }}" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="email" name="email" class="form-control" value="{{ $admin->email }}" placeholder="{{ trans('dash.email') }}" >
                        </div>
                    </div>
                    <div class="form-group">
