...
<div class="row">
        ...
        <form action="{{ route('user.update', $user->id) }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"> {{ trans('dash.edit_user') }} </h5>                    
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-lg-3 control-label">{{ trans('dash.username') }}</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="username" value="{{ $user->username }}" placeholder="{{ trans('dash.username') }}" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="email" name="email" class="form-control" value="{{ $user->email }}" placeholder="{{ trans('dash.email') }}" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-right">
                        ...
                        <a href="{{ route('user.index') }}" class="btn btn-success">{{ trans('dash.back_to_menu') }}</a>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div class="col-md-6">
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h5 class="panel-title"> {{ trans('dash.last_users') }} </h5>                    
            </div>
            <div class="panel-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        <td> {{ $user->username }}</td>
                        <td> <img height="80px" width="80px" src="{{ $user->image400 }}" /> </td>
                    </tr>
                    @empty
                    @endforelse
                </table>
