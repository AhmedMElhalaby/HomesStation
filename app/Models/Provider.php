...
class Provider extends Model
{
    ...
    public function setCommercialRegisterImageAttribute($value)
    {
        if (isset($this->attributes['commercial_register_image']) && $this->attributes['commercial_register_image'] != '') {
            if (file_exists(public_path('storage/app/uploads/users/commercial_register_image/org' . "/" . $this->attributes['commercial_register_image']))) {
    ...
    public function getCommercialRegisterImage200Attribute()
    {
        if ($this->attributes['commercial_register_image'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/commercial_register_image/200' . "/" . $this->attributes['commercial_register_image']))) {
    ...
    {
        if ($this->attributes['commercial_register_image'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/commercial_register_image/400' . "/" . $this->attributes['commercial_register_image']))) {
                return asset('storage/app/uploads/default.png');
            }
    ...
    {
        if ($this->attributes['commercial_register_image'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/commercial_register_image/600' . "/" . $this->attributes['commercial_register_image']))) {
                return asset('storage/app/uploads/default.png');
            }
