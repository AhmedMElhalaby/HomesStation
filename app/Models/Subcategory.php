...
class Subcategory extends Model
{
    ...
    public function setImageAttribute($value)
    {
        if (isset($this->attributes['image']) && $this->attributes['image'] != '') {
            if (file_exists(storage_path('app/uploads/subcategory/org' . "/" . $this->attributes['image']))) {
    ...
    public function getImage200Attribute()
    {
        if ($this->attributes['image'] != "") {
            if (!file_exists(storage_path('app/uploads/subcategory/200' . "/" . $this->attributes['image']))) {
    ...
    {
        if ($this->attributes['image'] != "") {
            if (!file_exists(storage_path('app/uploads/subcategory/400' . "/" . $this->attributes['image']))) {
                return asset('storage/app/uploads/default.png');
            }
    ...
    {
        if ($this->attributes['image'] != "") {
            if (!file_exists(storage_path('app/uploads/subcategory/600' . "/" . $this->attributes['image']))) {
                return asset('storage/app/uploads/default.png');
            }
