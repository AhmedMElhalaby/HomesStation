...
class BankAccount extends Model
{
    ...
    public function delete()
    {
        if (isset($this->attributes['logo_bank']) && $this->attributes['logo_bank'] != '') {
            if (file_exists(public_path('storage/app/uploads/bank_account/org' . "/" . $this->attributes['logo_bank']))) {
    ...
    public function getLogoBank200Attribute()
    {
        if ($this->attributes['logo_bank'] != "") {
            if (!file_exists(public_path('storage/app/uploads/bank_account/200' . "/" . $this->attributes['logo_bank']))) {
    ...
    {
        if ($this->attributes['logo_bank'] != "") {
            if (!file_exists(public_path('storage/app/uploads/bank_account/400' . "/" . $this->attributes['logo_bank']))) {
                return asset('storage/app/uploads/default.png');
            }
    ...
    {
        if ($this->attributes['logo_bank'] != "") {
            if (!file_exists(public_path('storage/app/uploads/bank_account/600' . "/" . $this->attributes['logo_bank']))) {
                return asset('storage/app/uploads/default.png');
            }
