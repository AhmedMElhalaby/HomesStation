...
class User extends Authenticatable implements JWTSubject
{
    ...
    public function setAvatarAttribute($value)
    {
        if (isset($this->attributes['avatar']) && $this->attributes['avatar'] != '') {
            if (file_exists(public_path('storage/app/uploads/users/avatar/org' . "/" . $this->attributes['avatar']))) {
    ...
    public function setLicenseImageAttribute($value)
    {
        if (isset($this->attributes['license_image']) && $this->attributes['license_image'] != '') {
            if (file_exists(public_path('storage/app/uploads/users/license_image/org' . "/" . $this->attributes['license_image']))) {
    ...
    public function getImage200Attribute()
    {
        if ($this->attributes['avatar'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/avatar/200' . "/" . $this->attributes['avatar']))) {
    ...
    {
        if ($this->attributes['avatar'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/avatar/400' . "/" . $this->attributes['avatar']))) {
                return asset('storage/app/uploads/default.png');
            }
    ...
    {
        if ($this->attributes['avatar'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/avatar/600' . "/" . $this->attributes['avatar']))) {
                return asset('storage/app/uploads/default.png');
            }
    ...
    public function getLicenseImageUrlAttribute()
    {
        if ($this->attributes['license_image'] != "") {
            if (!file_exists(public_path('storage/app/uploads/users/license_image/600' . "/" . $this->attributes['license_image']))) {
                return asset('storage/app/uploads/default.png');
            }
